...
<p align="center">
  <strong>EN</strong> Feature flag patterns for progressive delivery.<br/>
  <strong>PT</strong> Padrões de feature flags para entrega progressiva.
</p>
...
| English | Português |
|---------|-----------|
| Feature flag patterns for progressive delivery. | Padrões de feature flags para entrega progressiva. |
